...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 30. ??? 14:38:44 2020
# Project:  ..\test\test.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile ..\test\test.pro
#############################################################################
...
Makefile: ../test/test.pro  c:/Qt/4.8.6/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.6\mkspecs\win32-g++ CONFIG+=release -o Makefile ..\test\test.pro
